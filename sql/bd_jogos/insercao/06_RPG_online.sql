...
VALUES ('2024-08-16 15:30:00', '01:45:00', 6),  -- id 16
       ('2024-08-16 18:00:00', '02:00:00', 6),  -- id 17
       ('2024-08-16 20:30:00', '02:30:00', 6);  -- id 18


-- 11. Tabela 'partida_jogador'
INSERT INTO partida_jogador (partida_id, jogador_id, pontuacao_alcancada)
VALUES (16, 8, 200),  -- Lionel completou a primeira missão com 200 pontos (200)
       (16, 9, 500),  -- Geralt completou a primeira missão com 500 pontos (500)

       (17, 8, 300),  -- Lionel completou a segunda missão com 300 pontos (200 + 300)
       (17, 9, 550),  -- Geralt completou a segunda missão com 550 pontos (500 + 550)

       (18, 8, 250),  -- Lionel completou a terceira missão com 250 pontos (200 + 300 + 250)
       (18, 9, 400);  -- Geralt completou a terceira missão com 400 pontos (500 + 550 + 400)
     

-- 12. Tabela 'partida_historico'
INSERT INTO partida_historico (partida_id, historico_id, pontuacao_alcancada)
VALUES (16, 8, 200),  -- Primeira missão com histórico do Lionel(segunda posição)
       (16, 9, 500),  -- Primeira missão com histórico do Geralt (primeira posição )
	
       (17, 8, 300),  -- Segunda missão com histórico do Lionel(segunda posição)
       (17, 9, 550),  -- Segunda missão com histórico do Geralt(primeira posição)

       (18, 8, 250),  -- Segunda missão com histórico do Lionel(segunda posição)
       (18, 9, 400);  -- Segunda missão com histórico do Geralt(primeira posição)
